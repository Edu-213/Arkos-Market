            ...
            <div className='mt-6 sm:mx-auto sm:w-full sm:max-w-sm'>
                <form onSubmit={handleLogin} className='space-y-1'>
                    <div className='relative'>
                        <label htmlFor='emailCpf' className='text-sm font-medium text-gray-400'> E-mail ou CPF </label>
                        <div className='relative mt-1'>
                            <span className='absolute inset-y-3 left-0 pl-3 flext items-center text-gray-400'><FontAwesomeIcon icon={faUser} /></span>
                            <input type='text' id='emailCpf' name='emailCpf' value={emailCpf} onChange={handleEmailCpfChange} className='block w-full px-3 py-3 pl-8 border border-gray-300 shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm'/>
                        </div>
                    ...
                    <div className='relative'>
                        ...
                        <div className='relative mt-1'>
                            <span className='absolute inset-y-3 left-0 pl-3 flext items-center text-gray-400'><FontAwesomeIcon icon={faLock} /></span>
                            <input type={showPassword ? "text" : "password"} id='password' name='password' value={password} onChange={handlePasswordChange} className='block w-full px-3 py-3 pl-8 border border-gray-300 shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm'/>
                            <button type="button" onClick={() => setShowPassword(!showPassword)} className='absolute right-2 top-3'><FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} className="text-gray-500" /></button>
                        </div>
                        {passwordError && <p className='text-sm text-red-600 mt-1'>{passwordError}</p>}
                    </div>
                    <div className='text-red-600 py-1 pb-2'>
                        {message && <p>{message}</p>}
                    </div>
                    <div>
                        <button type='submit' className='w-full py-2 px-4 text-md sm:text-xl font-medium border border-transparent shadow-sm text-white bg-orange-600 focus:ring-2 focus:ring-offset-2 focus:ring-orange-500'> 
                    ...
                    <div className='flex justify-end'>
                        <a href="/" className='text-sm font-bold underline text-gray-400'>Esqueceu a senha?</a>
                    </div>
                </form>
                ...
                <div className='mt-6 text-center'>
                    <p className='text-gray-500'>
                        Novo no SITE? <Link to='/cadastro' className='text-orange-600 underline'>CADASTRE-SE</Link>
                    </p>
                </div>
            </div>
        </div>
